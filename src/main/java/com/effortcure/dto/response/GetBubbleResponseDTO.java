...
public class GetBubbleResponseDTO {
    ...
    public GetBubbleResponseDTO() {
    }

    public GetBubbleResponseDTO(UUID uuid, String name, String description, BubbleType type, String createdAt,
