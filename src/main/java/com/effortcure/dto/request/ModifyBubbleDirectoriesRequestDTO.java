...
public class ModifyBubbleDirectoriesRequestDTO {
     private String name;
    private String description;
    private List<String> applicationsNameList;
    private List<DirectoryRequestDTO> directoriesList;
    public ModifyBubbleDirectoriesRequestDTO() {
    }
    public ModifyBubbleDirectoriesRequestDTO(String name, String description, List<String> applicationsNameList,
