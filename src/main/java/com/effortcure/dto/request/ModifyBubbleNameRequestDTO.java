...
public class ModifyBubbleNameRequestDTO {
    private String name;
    private String description;
    private List<String> applicationsNameList;
    private List<DirectoryRequestDTO> directoriesList;

    public ModifyBubbleNameRequestDTO() {
    }

    public ModifyBubbleNameRequestDTO(String name, String description, List<String> applicationsNameList,
