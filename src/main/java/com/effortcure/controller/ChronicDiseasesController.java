...
public class ChronicDiseasesController {
    ...
    // Title
    @FXML
    private Pane chronicdiseasespane;
    @FXML
    ...
    // Image
    @FXML
    private ImageView chronicdiseasesimg;
    ...
    public void initialize() {
        ...
        skipbutton.setOnAction(e -> {
            NavigationData.nextPage = "/fxml/eye-health.fxml";
    ...
    @FXML
    private void moveToEyeQues() {
        SceneManager.switchScene("/fxml/eye-health.fxml", null);
    }

    @FXML
    private void backToAboutQues() {
